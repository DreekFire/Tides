...
local trim = {yaw = 0, pitch = 0.07, roll = 0}
...
function Sight(I, target)
  ...
  if target then
    ...
    local t = Targeting.secondOrderTargetingTime(relPos + gunOffset, relVel, accel, muzzle, 0.01, 2 * lockRange / muzzle)
